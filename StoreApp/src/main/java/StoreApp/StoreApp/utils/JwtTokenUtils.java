package StoreApp.StoreApp.utils;
...
public class JwtTokenUtils {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        String userId = getUserIdFromUserDetails(userDetails); // Giả sử bạn có phương thức này để lấy ID
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        String expectedUserId = getUserIdFromUserDetails(userDetails);
