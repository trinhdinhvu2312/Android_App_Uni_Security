...
create table category (id integer not null auto_increment, category_name nvarchar(1111), category_Image nvarchar(1111), primary key (id)) engine=InnoDB;
...
-- Insert dữ liệu
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `user_Name`, `avatar`, `email`, `phone_Number`) VALUES ('admin', 'default', 'admin', 'MQ==', 'Trịnh Đình Vũ', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'trinhdinhvu2312@gmail.com', '0942060073');


INSERT INTO `fashionstore`.`category` (`category_Name`, `category_Image`) VALUES ('Shirt', 'http://res.cloudinary.com/drlroexjl/image/upload/v1680274964/x7flicywwwot55owhplf.png');
INSERT INTO `fashionstore`.`category` (`category_Name`, `category_Image`) VALUES ('Trousers', 'http://res.cloudinary.com/drlroexjl/image/upload/v1680275077/n8titxsppsikgxcll4io.png');
INSERT INTO `fashionstore`.`category` (`category_Name`, `category_Image`) VALUES ('Shoe', 'http://res.cloudinary.com/drlroexjl/image/upload/v1680275274/hcjjxci4dbhv1ygdpy6h.png');
INSERT INTO `fashionstore`.`category` (`category_Name`, `category_Image`) VALUES ('Hat', 'http://res.cloudinary.com/drlroexjl/image/upload/v1680324268/hcnqr1oxxun4yo91oyyb.png');
INSERT INTO `fashionstore`.`category` (`category_Name`, `category_Image`) VALUES ('Glasses', 'http://res.cloudinary.com/drlroexjl/image/upload/v1680275160/uznqkjaucv2s4ys85rpl.png');
